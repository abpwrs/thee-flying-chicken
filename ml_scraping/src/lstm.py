...
checkpoint = ModelCheckpoint('output/lstm/{val_acc:.4f}.hdf5', monitor='val_acc', verbose=1, save_best_only=True,
                             mode='auto')
...
best = save_best_model(10, "output/lstm", 5, ".hdf5")

model.load_weights(best)

model.save("output/lstm/best.hdf5")
